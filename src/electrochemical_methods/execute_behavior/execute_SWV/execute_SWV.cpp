 ...
 * 
 *****************************************************************************/
int C_Execute_SWV::Begin(C_DataSoftwareStorage * c_DataSoftwareStorage){
...
/******************************************************************************
 * @brief Method for implementing interrupt service routine for square wave 
 * voltammetry
 * 
 ...
 * sequences of the square wave voltammetry
 * 
