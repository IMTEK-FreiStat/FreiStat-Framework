/******************************************************************************
 * @brief: Source file containing the subclass (C_Execute) C_Execute_LSV which 
...
// Include guard
#ifndef execute_LSV_CPP
#define execute_LSV_CPP

// Include dependencies
#include "execute_LSV.h"

/******************************************************************************
 * @brief Constructor of the class C_Execute_LSV
 * 
 *****************************************************************************/ 
C_Execute_LSV::C_Execute_LSV(){}

/******************************************************************************
 * @brief Starting method for the class C_Execute_LSV
 * @param c_DataSoftwareStorage: Reference to data software storage object
 * 
 *****************************************************************************/
void C_Execute_LSV::Begin(C_DataSoftwareStorage * c_DataSoftwareStorage){
    ...
    // Convert char arry with experiment type to integer
 ...
 *****************************************************************************/
int C_Execute_LSV::funInterruptServiceRoutine(){
...
int C_Execute_LSV::funProcessExperimentData(uint32_t * pData, 
    ...
    if (uiCountData > 0){                                                            
        ...
        S_DataContainer S_ExperimentData2 = c_DataStorageGeneral_->
            get_ExperimentData(this->funGetDataPosition(iCurrentStep - 1));
 ...
 *****************************************************************************/
int C_Execute_LSV::funControlApplication(uint32_t uiCommand){
 ...
 * @return: Returns error code encoded as integer
 *****************************************************************************/
int C_Execute_LSV::funSequencerDACControl(){
    // Initialize variables
    bool bFinalBlock;
 ...
 * @return: Returns error code.
 *****************************************************************************/
int C_Execute_LSV::funUpdateDACRegister(uint32_t * ipDacData){
    // Initalize variables
    uint32_t iVbiasCode;
    uint32_t iVzeroCode;
    ...
    case EC_METHOD_STATE_0:
        ...
        // Reset starting posistion of DAC
    ...
    iVbiasCode = (uint32_t)(iVzeroCode * 64 - 
 ...
 * @return: Returns error code.
 *****************************************************************************/
int C_Execute_LSV::funPreCalulations(){
    // Get ADC gain
