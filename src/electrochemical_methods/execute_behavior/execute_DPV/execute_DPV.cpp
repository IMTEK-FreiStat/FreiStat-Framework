 ...
 * 
 *****************************************************************************/
int C_Execute_DPV::Begin(C_DataSoftwareStorage * c_DataSoftwareStorage){
...
/******************************************************************************
 * @brief Method for implementing interrupt service routine for differential 
 * pulse voltammetry
 * 
 ...
 * sequences of the differential pulse voltammetry
 * 
