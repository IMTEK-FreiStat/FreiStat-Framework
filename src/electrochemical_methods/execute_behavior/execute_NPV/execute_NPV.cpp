/******************************************************************************
 * @brief: Source file containing the subclass (C_Execute) C_Execute_NPV which 
...
// Include guard
#ifndef execute_NPV_CPP
#define execute_NPV_CPP

// Include dependencies
#include "execute_NPV.h"

/******************************************************************************
 * @brief Constructor of the class C_Execute_NPV
 * 
 *****************************************************************************/ 
C_Execute_NPV::C_Execute_NPV(){}

/******************************************************************************
 * @brief Starting method for the class C_Execute_NPV
 * @param c_DataSoftwareStorage: Reference to data software storage object
 * 
 *****************************************************************************/
void C_Execute_NPV::Begin(C_DataSoftwareStorage * c_DataSoftwareStorage){
 ...
 *****************************************************************************/
int C_Execute_NPV::funInterruptServiceRoutine(){
...
int C_Execute_NPV::funProcessExperimentData(uint32_t * pData, 
    ...
    float fAdcReferenceVoltage = c_DataStorageGeneral_->
                                    get_ADCReferenceVoltage();
 ...
 *****************************************************************************/
int C_Execute_NPV::funControlApplication(uint32_t uiCommand){
    // Initialize variables
 ...
 *****************************************************************************/
int C_Execute_NPV::funUpdateSequence(){
    // Initialize variables
    ...
    if (iDacCurrentBlock == CURRENT_BLOCK_1){
        uiVbiasCode = (uiVzeroCode * 64 - (c_DataStorageLocal_->
            get_LowerVoltage() / AD5940_12BIT_DAC_1LSB));
    }
    else if (iDacCurrentBlock == CURRENT_BLOCK_0){
        uiVbiasCode = (uiVzeroCode * 64 - c_DataStorageLocal_->get_PotentialSteps(1) / 
 ...
 * 
 *****************************************************************************/
int C_Execute_NPV::funConfigAfeReferenceBuffer(){
