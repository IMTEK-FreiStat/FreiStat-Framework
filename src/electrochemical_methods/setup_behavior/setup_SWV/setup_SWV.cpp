/******************************************************************************
 * @brief: Source file containing the subclass (C_Setup) C_Setup_SWV which 
...
// Include guard
#ifndef setup_SWV_CPP
#define setup_SWV_CPP

// Include dependencies
#include "setup_SWV.h"

/******************************************************************************
 * @brief Constructor of the class C_Setup_SWV
 * 
 *****************************************************************************/ 
C_Setup_SWV::C_Setup_SWV(){}

/******************************************************************************
 * @brief Starting method for the class C_Setup_SWV
 ...
 * @return: Error code encoded as integer
 *****************************************************************************/
int C_Setup_SWV::funSequencerInitializationSequence(){
    // Initalize variables
 ...
 *****************************************************************************/
int C_Setup_SWV::funSequencerExecuteSequence(){
    // Initialize variables
