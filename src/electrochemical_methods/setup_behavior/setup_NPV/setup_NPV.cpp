/******************************************************************************
 * @brief: Source file containing the subclass (C_Setup) C_Setup_NPV which 
...
// Include guard
#ifndef setup_NPV_CPP
#define setup_NPV_CPP

// Include dependencies
#include "setup_NPV.h"

/******************************************************************************
 * @brief Constructor of the class C_Setup_NPV
 * 
 *****************************************************************************/ 
C_Setup_NPV::C_Setup_NPV(){}

/******************************************************************************
 * @brief Starting method for the class C_Setup_NPV
...
int C_Setup_NPV::funInitNPV(){
    ...
    c_DataStorageLocal_->set_LowerVoltage(
 ...
 * @return: Error code encoded as integer
 *****************************************************************************/
int C_Setup_NPV::funSequencerInitializationSequence(){
    // Initalize variables
 ...
 *****************************************************************************/
int C_Setup_NPV::funSequencerExecuteSequence(){
    // Initialize variables
