/******************************************************************************
 * @brief: Source file containing the subclass (C_Setup) C_Setup_CA which 
 ...
 * @return: Error code encoded as integer
 *****************************************************************************/
int C_Setup_CA::funSequencerInitializationSequence(){
    // Initalize variables
 ...
 *****************************************************************************/
int C_Setup_CA::funSequencerExecuteSequence(){
    // Initialize variables
    const uint32_t *uiSequenceCommand;
