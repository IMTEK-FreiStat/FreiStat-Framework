"""
Module implementing the behavior of the setup function for running normal
pulse voltammetery.
...
class SetupNPV(SetupBehavior):
    ...
    def setup(self, listExperimentParameters: list) -> int:
        ...
        Description
        -----------
        Setup method for normal pulse voltammetry
        ...
        11100       :   BaseVoltage named wrong or not found as 1 entry
        11101       :   StartVoltage named wrong or not found as 2 entry
        11102       :   StopVoltage named wrong or not found as 3 entry
        11103       :   DeltaV_Staircase named wrong or not found as 4 entry
        ...
        11200       :   BaseVoltage out of bounds
        11201       :   StartVoltage out of bounds
        11202       :   StopVoltage out of bounds
        11203       :   DeltaV_Staircase out of bounds
        ...
        fMaxVoltage = listExperimentParameters[2][1] + listExperimentParameters[3][1]
        ...
        listReferenceList = [
            [BASE_POTENTIAL, -VOLTAGE_RANGE_FWP, listExperimentParameters[1][1]],
            [START_POTENTIAL, fMinVoltage, fMaxVoltage],
            [STOP_POTENTIAL, fMinVoltage, fMinVoltage + fVoltageRange],
            [DELTA_V_STAIRCASE, 0, fVoltageRange - fMaxVoltage],
        ...
        if len(listExperimentParameters) != NPV_NUM_PARAMETER:
        ...
        self._dataHandling.save_ExperimentType(NPV)
