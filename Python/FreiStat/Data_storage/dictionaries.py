...
dic_configParameters = {
    ...
    BASE_POTENTIAL      : ["Base Potential",
                           "Base potential in mV"],
    START_POTENTIAL     : ["Start potential",
    ...
    AC_AMPLITUDE        : ["Amplitude of the sinussignal",
                           "Vp in mV"],
    DC_OFFSET           : ["Dc offset",
                           "Dc ofset in mV"],
    ...
    UPPER_POTENTIAL     : ["Upper turning potential",
                           "Upper potential in mV"],
    POTENTIAL_STEPS     : ["Potential steps",
                           "Potential steps in mV"],
    PULSE_LENGTH        : ["Pulse lengths",
                           "Pulse lengths in ms"],
    ...
    SCAN_RATE           : ["Scan rate",
                           "Scanrate in mV/s"],
    DELTA_V_STAIRCASE   : ["Delta V staircase",
                           "Delta V staircase in mV"],
    DELTA_V_PEAK        : ["Delta V peak",
                           "Delta V peak in mV"],
    CYCLE               : ["Cycles",
                           "Number of cycles"],
    LPTIA_RTIA_SIZE     : ["Current range",
                           "Rtia resistor size encoded as integer"],
