...
-----------------------------------------------------------------------------"""
FREISTAT_STANDALONE = (
    "standalone"  # The FreiStat library is used as an standalone library
)
...
VOLTAGE_RANGE_FWP = (
    2150.0  # Voltage range FreiStat supplies while using fixed WE potential
)
...
FREISTAT_CA_ST_SERIAL = (
    3.000e-3  # Minimal sampling time in s at which the CA still operates
)
FREISTAT_CV_ST_SERIAL = (
    2.875e-3  # Minimal sampling time in s at which the CV still operates
)
FREISTAT_DPV_ST_SERIAL = (
    3e-3  # Minimal sampling time in s at which the DPV still operates
)
...
FREISTAT_CORE_DATA_FOLDER = (
    "Measurements"  # Core folder for storing all experiment parameters
)
FREISTAT_DATA = "Experiment_Data"  # File name for exporting data
FREISTAT_EXPERIMENT_PARAMETERS = (
    "Experiment_Parameters"  # File name for exporting experiment parameters
)
FREISTAT_SEQUENCE_POSITION = (
    "SP"  # Addition for the file name indicating the position in the sequence
)
...
|   Constant              Value
-----------------------------------------------------------------------------"""
FREISTAT_OCP_LABEL = [DE_TAG_CYCLE, DE_TAG_DATAPOINT, DE_TAG_VOLTAGE, DE_TAG_TIME]
FREISTAT_OCP_LABEL_SEQ = [
    DE_TAG_SEQ_CYCLE,
    DE_TAG_CYCLE,
    DE_TAG_DATAPOINT,
    DE_TAG_VOLTAGE,
...
|   Constant              Value                     Meaning
-----------------------------------------------------------------------------"""
EC_SE_AMOUNT_PARAMETER = (
    1  # Amount of parameters given to the function doesn't match required amount.
)
...
EC_SE_INHERIT_ERROR = (
    999  # Class inheritance not properly, tired to execute parent class
)
