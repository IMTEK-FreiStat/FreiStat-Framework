"""
Module which implements a facade interface for executing linear sweep 
voltammetry.
...
class Run_LSV(Run_Electrochemical_Method):
    """
    Description
    -----------
    Facade which implements linear sweep voltammetry on the FreiStat.
    ...
    def start(self, 
        ...
        if (EnableOptimizer == True):
            ...
            # Start optimization
            iErrorcode = _Optimizer.start(LSV, self._listExperimentParameters)
