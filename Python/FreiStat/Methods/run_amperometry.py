...
class Run_A(Run_Electrochemical_Method):
    """
    Description
    -----------
    ...
    """
    def start(self, 
              Potential : float = START_POTENTIAL_F,
        ...
        # FreiStat
        listPotential_Steps.append(self._check_StartingPotential(Potential * 1000.0, 1))
        
        # Safe experiment parameters in correct list format for chronoamperometry
        self._listExperimentParameters = [
            [POTENTIAL_A, listPotential_Steps],
        ...
        if (EnableOptimizer == True):
            ...
            # Start optimization
            iErrorcode = _Optimizer.start(A, self._listExperimentParameters)
