...
class Run_DPV(Run_Electrochemical_Method):
    ...
    Description
    -----------
    Facade which implements differential pulse voltammetry on the FreiStat.
    ...
    def start(
        ...
        Description
        -----------
        Start differential pulse voltammetry with defined parameters.
        ...
        if EnableOptimizer == True:
            ...
            # Start optimization
            iErrorcode = _Optimizer.start(DPV, self._listExperimentParameters)
